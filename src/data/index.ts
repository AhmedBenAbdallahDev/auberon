...
export const workItems = [
    {
        ...
        description: "A complete overhaul of an e-commerce platform, focusing on user experience optimization and modern design principles. Implemented with Next.js and Tailwind CSS.",
    ...
    },
    {
        ...
        description: "Strategic rebranding project delivering a cohesive visual identity system, including digital assets and comprehensive brand guidelines.",
        category: "Branding",
        tag: "Brand Identity",
        img: "/b2.jpg",
    },
    {
        ...
        description: "Custom analytics dashboard built for tracking marketing campaigns and user engagement metrics in real-time.",
